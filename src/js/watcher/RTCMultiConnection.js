// Last time updated at Nov 10, 2014, 08:32:23
...
(function() {
    ...
    function getUserMedia(options) {
        ...
        if (currentUserMediaRequest.streams[idInstance]) {
            ...
            // http://goo.gl/eETIK4
            /*
            n.getMedia(hints, function(stream){
    ...
    var isFirefox = typeof window.InstallTrigger !== 'undefined' || navigator.mozPower != undefined;
    ...
    function createMediaElement(stream, session) {
        ...
        console.log('createMediaElement');
        ...
        console.log('element created:',mediaElement);
    ...
    (function() {
        ...
        function CheckDeviceSupport(callback) {
            ...
            if (isPluginRTC || isFirefox || navigator.mozCameras) {
                callback && callback();
                return;
            }
